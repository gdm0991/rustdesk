        ...
        child: _Card(title: translate('About RustDesk'), children: [
          Column(
            ...
            children: [
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://duga.pw/privacy.html');
                  },
                  child: Text(
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            'DugaDesk — на основе RustDesk. Copyright © ${DateTime.now().toString().substring(0, 4)} Purslane Tech Pte. Ltd.\n$license',
